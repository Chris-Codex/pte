...
const Banner = () => {
    return (
        <section className="bg-gray-200 pb-30">
            ...
            <div className="grid grid-cols-1 mx-4 lg:flex gap-3 items-center justify-center mt-10">
                <CustomBtn text="Start Your Journey" classes='cursor-pointer w-full lg:w-[180px] bg-amber-500 py-2 rounded-md text-[18px] text-white' />
                <CustomBtn text="Learn More" classes='cursor-pointer w-full lg:w-[130px] bg-white py-1.5 rounded-md text-[18px] text-black border border-[#000] border-2 hover:bg-[#0B2752] hover:text-white' />
            </div>

            <div className='flex items-center justify-center'>
                <div className='flex flex-col w-full mx-4 md:flex-row lg:grid lg:grid-cols-3 lg:place-items-center lg:w-[650px] gap-8  mt-20'>
