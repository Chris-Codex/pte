  ...
  return (
    <section className="bg-gray-100 w-full pt-10 pb-20 md:pt-20 lg:pt-20" id="upcoming">
      ...
      <div className="flex items-center  justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 lg:grid-cols-3 lg:gap-10">
          <ClassesCard
            category="All Levels"
            seats="5 seats left"
      ...
      <div className="flex items-center justify-center mt-10 mx-5 lg:mx-0">
        <p className="text-gray-600">
          Can't find a suitable time?{" "}
          <span className="text-[#f59e0b] font-semibold">Contact us</span> to
          discuss custom schedules.
        </p>
      </div>
    </section>
  );
